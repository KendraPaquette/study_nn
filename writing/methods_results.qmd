...
Figure X presents histograms that display the distribution of the proportion of EMA observations revealed for each participant. 
...
Median auROCs for the 5 neural network models are presented in the table below. <!--We won't include XGBoost in manuscript, just keeping here for now for us.-->
```{r}
#| echo: false
